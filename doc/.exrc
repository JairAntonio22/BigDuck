...
set backspace=2
set cindent
set cinoptions=:0,l1,g0,t0,i0,(s,U1,W1s,m1
set expandtab
...
set mouse=a
set ruler
set runtimepath=~/.vim,~/.vim/plugged/nord-vim,~/.vim/plugged/ale,~/.vim/plugged/vimtex,~/.vim/plugged/vim-antlr,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/plugged/vimtex/after,~/.vim/after
set scrolloff=2
set shiftwidth=4
set smartcase
set softtabstop=4
